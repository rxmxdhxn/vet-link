...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-80 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            <a href="#" class="flex rounded-lg items-center active-nav-link text-white py-4 pl-6 nav-item transition duration-300 ease-in-out">
                <img src="images/dashboard.png" class="mr-3 w-6" alt="">
                Dashboard
            </a>
            <a href="#" class="mt-5 rounded-lg flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item transition duration-300 ease-in-out">
